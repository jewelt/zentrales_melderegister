...
public class PatientRecord extends UpdatableRecordImpl<PatientRecord> implements Record3<Long, OffsetDateTime, Long> {

    private static final long serialVersionUID = 1471226257;
     ...
     */
    @Override
    public Row3<Long, OffsetDateTime, Long> fieldsRow() {
     ...
     */
    @Override
    public Row3<Long, OffsetDateTime, Long> valuesRow() {
     ...
     */
    @Override
    public PatientRecord values(Long value1, OffsetDateTime value2, Long value3) {
        value1(value1);
        value2(value2);
        value3(value3);
        return this;
     ...
     */
    public PatientRecord(Long id, OffsetDateTime birthday, Long cityId) {
        super(Patient.PATIENT);
