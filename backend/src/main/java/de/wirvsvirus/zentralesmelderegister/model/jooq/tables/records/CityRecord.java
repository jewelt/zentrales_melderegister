...
public class CityRecord extends UpdatableRecordImpl<CityRecord> implements Record5<Long, BigDecimal, BigDecimal, String, Long> {

    private static final long serialVersionUID = 558973085;
     ...
     */
    @Override
    public CityRecord values(Long value1, BigDecimal value2, BigDecimal value3, String value4, Long value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public CityRecord(Long id, BigDecimal coordinatesLongitude, BigDecimal coordinatesLatitude, String name, Long countryId) {
        super(City.CITY);
